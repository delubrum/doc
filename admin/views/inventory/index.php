    ...
    <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <form method="post" autocomplete="off" enctype="multipart/form-data" action="?c=Invetory&a=Index">
            ...
            <div class="card-body" style="display: block;">
                <form method="post" autocomplete="off" enctype="multipart/form-data" action="?c=Invetory&a=Index" id="Filters_Form">
                    <div class="row">
