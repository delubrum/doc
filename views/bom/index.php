    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                ...
                <h1 class="m-0 text-dark">Bill Of Materials</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card card-primary card-outline">
            ...
            <div class="card-body" style="display: block;">
                <form method="post" autocomplete="off" enctype="multipart/form-data" action="?c=BOM&a=Index">
                    <div class="row">
                        <div class="col-sm-1">
...
$(".new").on("click", function() {
    id = $(this).data('id');
    $.post( "?c=BOM&a=New", { id }).done(function( data ) {
