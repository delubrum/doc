  ...
  <div class="modal-body">
    ...
    <table style='text-align:center;width:100%;padding:0' class="mb-4">
        <tr>
            ...
            <td style='width:33%'><h1>MAINTENANCE SERVICE DESK</h1></td>
            <td style='width:33%;font-size:18px'>
                <b>Code:</b> F02-PRML-01
                <br>
                <b>Date:</b> 2022-08-02
                <br>
                <b>Version:</b> 01
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <dl>
                <dt><i class="fas fa-clipboard-list"></i> LOCATION:</dt>
                <dd><?php echo $id->location ?></dd>
            </dl>
        </div>
        <div class="col-sm-12">
            <dl>
    ...
    <?php if($status == 'assign') { ?> 
        <div class="col-sm-12 mt-3">
            <div class="form-group">
                <label>* Assign To:</label>
                <div class="input-group">
                    <select class="form-control form-control-sm select2" name="fillBy" style="width: 100%;" required>
                        <option value=''></option>
                        <?php
    ...
    <?php if($status == 'process' or $status == 'view') { ?> 
    <div class="row">
