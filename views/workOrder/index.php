    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                ...
                <h1 class="m-0 text-dark">Work Orders</h1>
            </div>
        </div>
    </div>
</div>
...
$(document).on('submit', '#workOrderNew_form', function(e) {
    e.preventDefault();
    if (document.getElementById("workOrderNew_form").checkValidity()) {
        $("#loading").show();
        $.post( "?c=WorkOrders&a=Save", $( "#workOrderNew_form" ).serialize()).done(function(res) {
...
$(".new").on("click", function() {
    id = $(this).data('id');
    $.post( "?c=WorkOrders&a=New", { id }).done(function( data ) {
        $('#xsModal').modal('toggle');
